...
from source_facebook_insights.metrics import PAGE_FIELDS, PAGE_METRICS, POST_FIELDS, POST_METRICS
...
class Post(FacebookInsightsStream):
    """
...
class PageInsights(FacebookInsightsStream):
    """
...
class PostInsights(FacebookInsightsStream):
    """
